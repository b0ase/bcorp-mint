  ...
  try {
        ...
        <Page size="A4" style={styles.page}>
          ...
          <View style={styles.proofBox}>
            ...
            <View style={styles.proofRow}>
              ...
              <Text style={styles.proofValue}>https://bitcoin-mint.com/verify/{id}</Text>
            </View>
          ...
          <Text style={styles.footer}>
            Generated by BITCOIN MINT | bitcoin-mint.com | Bitcoin SV Blockchain Verified
          </Text>
        </Page>
      </Document>
    );
    ...
    return new NextResponse(uint8, {
      headers: {
        ...
        'Content-Disposition': `inline; filename="bitcoin-mint-${id.slice(0, 8)}.pdf"`,
      },
    });
  } catch (error: any) {
