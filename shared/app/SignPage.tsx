...
export default function SignPage() {
  ...
  if (!handle) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center">
        ...
        <button onClick={login} className="px-8 py-3 bg-white text-black font-medium text-sm rounded-md hover:bg-zinc-200 transition-all">
  ...
  if (showNewDoc) {
    // Lazy-load NewDocumentPage for desktop compatibility
  ...
  return (
    <div className="min-h-screen text-white overflow-x-hidden">
      <div className="relative z-10 p-6 pt-8 max-w-6xl mx-auto space-y-12 pb-40">
        {/* Header */}
